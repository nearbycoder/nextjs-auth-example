  ...
  return (
    <ApolloProvider client={client}>
      <ClientOnly>
        ...
        />
        <div
          className="fixed top-0 right-0 w-1/2 h-full hidden sm:fixed"
          aria-hidden="true"
        />
          ...
          <div className="flex-grow w-full max-w-7xl mx-auto xl:px-8 lg:flex">
            ...
            <div className="flex-1 min-w-0 bg-white xl:flex">
              <div className="border-b border-gray-200 xl:border-b-0 xl:flex-shrink-0 xl:w-64 xl:border-r xl:border-gray-200 bg-white">
                <div className="h-full pl-4 pr-6 py-6 sm:pl-6 lg:pl-8 xl:pl-0 hidden sm:block">
            ...
            <div className="pr-4 sm:pr-6 lg:pr-8 lg:flex-shrink-0 lg:border-l lg:border-gray-200 xl:pr-0">
              <div className="h-full pl-6 py-6 lg:w-80 hidden sm:block">
